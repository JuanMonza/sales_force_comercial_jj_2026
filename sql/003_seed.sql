...
INSERT INTO users (id, tenant_id, role_id, email, password_hash, first_name, last_name, document_id, is_active) VALUES
  ('77777777-7777-7777-7777-777777777771', '11111111-1111-1111-1111-111111111111', 1, 'admin@demo.com', 'Admin123!', 'Admin', 'Demo', '1001', TRUE),
  ('77777777-7777-7777-7777-777777777772', '11111111-1111-1111-1111-111111111111', 2, 'director@demo.com', 'Admin123!', 'Diana', 'Director', '1002', TRUE),
  ('77777777-7777-7777-7777-777777777773', '11111111-1111-1111-1111-111111111111', 3, 'coordinador@demo.com', 'Admin123!', 'Carlos', 'Coordinador', '1003', TRUE),
  ('77777777-7777-7777-7777-777777777774', '11111111-1111-1111-1111-111111111111', 4, 'asesor@demo.com', 'Admin123!', 'Ana', 'Asesor', '1004', TRUE)
ON CONFLICT (id) DO NOTHING;
